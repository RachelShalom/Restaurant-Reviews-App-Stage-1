    ...
    fetchRestaurantFromURL((error, restaurant) => {
        if (error) { // Got an error!
            ...
            L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token=pk.eyJ1IjoicmFjaGVsc2hhbG9tIiwiYSI6ImNqaXp3bG1hejBhc2MzcW1odmtqbTQ3Y3IifQ.ygRfsJVddbhT65JnLaBMqA', {
                mapboxToken: 'pk.eyJ1IjoicmFjaGVsc2hhbG9tIiwiYSI6ImNqaXg5azNudTI5aHkzd252ejQzYjdnNWIifQ.vnJAntk1pAfYF-JzzLmpyw',
                maxZoom: 18,
...
createReviewHTML = (review) => {
    ...
    nameDateContainer.setAttribute("class","name-date-container");
